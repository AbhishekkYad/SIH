...
async def test_qr_resolution_and_non_state_mutating_scan(async_client, auth_headers):
    # Resolve pre-seeded batch "batch-apple-001-packaged"
    qr_payload = {"qr_reference": "batch-apple-001-packaged"}
    ...
    cred_payload = {
        ...
        "qr_reference": "batch-apple-001-packaged",
        "unit_or_batch_id": "batch-apple-001-packaged"
    }
