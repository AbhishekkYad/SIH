...
router.post('/scan', wrapper('recordScan', ['eventId', 'entityId']), submitTransaction);
router.post('/verify', wrapper('recordVerification', ['eventId', 'entityId', 'verificationResult']), submitTransaction);
