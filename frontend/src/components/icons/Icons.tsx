...
export const BrandMark: React.FC<IconProps> = ({
  size = 22,
  color = "#2E6B4E",
  ...props
}) => (
...
export const IconCore: React.FC<IconProps> = ({
  size = 20,
  color = "currentColor",
  strokeWidth = 1.5,
  ...props
...
export const IconTrace: React.FC<IconProps> = ({
  size = 20,
  color = "currentColor",
  strokeWidth = 1.5,
  ...props
...
export const IconFarmer: React.FC<IconProps> = ({
  size = 18,
  color = "currentColor",
  strokeWidth = 1.5,
  ...props
...
export const IconProcessor: React.FC<IconProps> = ({
  size = 18,
  color = "currentColor",
  strokeWidth = 1.5,
  ...props
...
export const IconManufacturer: React.FC<IconProps> = ({
  size = 18,
  color = "currentColor",
  strokeWidth = 1.5,
  ...props
...
export const IconTransport: React.FC<IconProps> = ({
  size = 18,
  color = "currentColor",
  strokeWidth = 1.5,
  ...props
...
export const IconRetailer: React.FC<IconProps> = ({
  size = 18,
  color = "currentColor",
  strokeWidth = 1.5,
  ...props
...
export const IconConsumer: React.FC<IconProps> = ({
  size = 18,
  color = "currentColor",
  strokeWidth = 1.5,
  ...props
...
export const IconRegulator: React.FC<IconProps> = ({
  size = 18,
  color = "currentColor",
  strokeWidth = 1.5,
  ...props
