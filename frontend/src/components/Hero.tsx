    ...
    <section className={styles.hpHero}>
      <div className="container">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/images/logineko/supply_chain_traceability_hero.jpg')",
          }}
        >
          ...
          <div className={styles.heroContent}>
            <div className={styles.heroEyebrow}>
              ...
              <span>National Food Traceability &amp; Safety Infrastructure</span>
            </div>

            <h1 className={styles.heroTitle}>
              From farm &amp; harvest to retail. <strong>Every single step verifiable.</strong>
            </h1>

            <p className={styles.heroLead}>
              A unified digital infrastructure connecting farmers, processors, logistics, retailers, and consumers.
              Replace fragmented paper trails with an immutable, cryptographically verifiable food journey.
            </p>
          ...
          <div className={styles.insightsHeader}>
            <div className={styles.insightsTitleWrap}>
              ...
              <h2 className={styles.insightsHeading}>
                Designed for <strong>uncompromising integrity</strong> at every tier.
              </h2>
            </div>
            <p className={styles.insightsSubtext}>
              Built on open standards (GS1 Digital Link, W3C DID, Hyperledger Fabric). Meaningful data trails without vanity metrics.
            </p>
          </div>
