      ...
      <div className="container">
        ...
        <div className={styles.header}>
          ...
          <h2 className={styles.title}>
            ...
            <strong>Tailored for every stakeholder.</strong>
          </h2>
          <p className={styles.lead}>
            FoodTrace operates on a clean, role-based access model. Every
            participant accesses precisely the data and actions relevant to
