    ...
    articles: [
      {
        ...
        excerpt:
          "The capability to trace and follow a food product, feed, or food-producing substance through all stages of production, processing, and distribution.",
        readTime: "3 min read",
      ...
      },
      {
        ...
        excerpt:
          "Bulk mixing obfuscates contamination origins. Tracking parent-child batch transformations enables targeted recall isolation without discarding safe harvests.",
        readTime: "4 min read",
      ...
      },
      {
        ...
        excerpt:
          "From seed sowing, soil health inputs, and harvest geofencing through milling, cold freight transit, retail shelf stock, and end-consumer smartphone scan.",
        readTime: "5 min read",
    ...
    articles: [
      {
        ...
        excerpt:
          "GS1 Digital Link dynamic QR codes bind a physical item to its digital twin on-chain, verifying cryptographic authenticity upon smartphone scan.",
        readTime: "3 min read",
      ...
      },
      {
        ...
        excerpt:
          "Origin farm cluster, harvest date, sortex purity, NABL pesticide test certificates, storage temperature adherence, and authorized retail chain.",
        readTime: "4 min read",
      ...
      },
      {
        ...
        excerpt:
          "Each supply chain handover is signed with W3C Decentralized Identifiers (DIDs) and validated across Hyperledger Fabric multi-org consensus.",
        readTime: "4 min read",
    ...
    articles: [
      {
        ...
        excerpt:
          "Mass balance weight, moisture content, temperature telemetry, GPS checkpoints, laboratory analysis results, and responsible custodian IDs.",
        readTime: "4 min read",
      ...
      },
      {
        ...
        excerpt:
          "Through a permissioned smart-contract layer that synchronizes state across disparate ERPs, APMC mandi registers, and warehouse management systems.",
        readTime: "5 min read",
      ...
      },
      {
        ...
        excerpt:
          "Automated scan-in / scan-out custody protocols at logistics hubs and distribution centers stream live tracking events to the blockchain.",
        readTime: "4 min read",
    ...
    articles: [
      {
        ...
        excerpt:
          "Open your standard smartphone camera app, point it at the QR code on the packaging, and tap the link to open the verifiable provenance timeline.",
        readTime: "2 min read",
      ...
      },
      {
        ...
        excerpt:
          "Your verified sensory report is logged with the batch ID. When complaint density crosses anomaly thresholds, automated quarantine protocols activate.",
        readTime: "4 min read",
      ...
      },
      {
        ...
        excerpt:
          "Feedback directly influences supplier quality scoring, triggers targeted warehouse audits, and ensures substandard batches never repeat.",
        readTime: "3 min read",
...
export default function KnowledgeFAQ() {
  ...
  const currentCat =
    KNOWLEDGE_CATEGORIES.find((c) => c.id === activeCategory) ||
      ...
      <div className="container">
        ...
        <div className={styles.header}>
          ...
          <p className={styles.lead}>
            Explore verified architectural whitepapers, cryptographic protocols,
            and consumer safety guidelines across four key domains.
          </p>
        </div>
        ...
        <div className={styles.faqWrap}>
          <div className={styles.faqHeader}>
            ...
            <p className={styles.faqLead}>
              Clear, professional answers to common questions about platform
              functionality, data privacy, and stakeholder integration.
            </p>
          </div>
